...
export function AdminHeader() {
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-forest/10 bg-white px-6 py-3 shadow-[0_15px_40px_rgba(26,60,46,0.08)]">
      <div className="flex items-center gap-2 rounded-full border border-forest/10 bg-neutral-50 px-4 py-2 text-xs font-semibold text-forest/70">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 rounded-full border border-forest/10 bg-white px-3 py-2 text-sm text-forest">
